...
const FormServiceSchema = z.object({
    ...
    categorie_id: z.string().nonempty('Danh mục không được để trống'),
    describe: z.string().nonempty('Số điện thoại không được để trống!'),
    price: z.string().nonempty('Vui lòng nhập giá cả!'),
    time: z.string().nonempty('Vui lòng nhập thời gian!'),
});
