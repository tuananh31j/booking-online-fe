            ...
            <AlertDialog>
                ...
                <AlertDialogContent className='w-[90%] rounded-lg px-2 duration-500'>
                    <AlertDialogHeader>
                        ...
                        <p className='text-center text-default md:text-4xl'>{t('title')}</p>
                        <p className='text-center text-xs text-[#7777] md:text-xl'>{t('desc')}</p>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel className='bg-card'>{t('button.cancel')}</AlertDialogCancel>
